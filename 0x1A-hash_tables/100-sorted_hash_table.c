...
/**
 * shash_table_set - Let's add an element to the sorted hash table
...
/**
 * shash_table_get - Let's get a value of a key in a sorted hash table
...
/**
 * shash_table_print - Lets print a sorted hash table
...
/**
 * shash_table_print_rev - lets,  print a sorted hash table in reverse
 * @ht: type pointer the sorted hash_table
 */
